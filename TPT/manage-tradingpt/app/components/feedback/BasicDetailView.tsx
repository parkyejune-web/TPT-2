      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-base">{data.settingStopLoss?.toLocaleString(undefined, { maximumFractionDigits: 8 }) || '-'}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">설정 익절가</label>
            <p className="text-base">{data.settingTakeProfit?.toLocaleString(undefined, { maximumFractionDigits: 8 }) || '-'}</p>
          </div>
        </div>
      </section>
