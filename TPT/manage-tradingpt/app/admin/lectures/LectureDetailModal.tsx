          ...
          <div>
            ...
            {lecture.videoKey ? (
              <div className="bg-gray-100 rounded-lg p-4">
                <p className="text-sm text-gray-600 mb-2">비디오 키:</p>
                <p className="text-sm text-gray-900 break-all">{lecture.videoKey}</p>
                <p className="text-xs text-gray-500 mt-2">
                  * 비디오 재생은 고객 사이트에서 재생 URL 발급 API를 통해 가능합니다.
                </p>
              </div>
            ) : (
                  ...
                  >
                    <div>
                      <p className="font-medium text-gray-900">
                        {attachment.fileKey.split('/').pop() || '첨부파일'}
                      </p>
                      <p className="text-xs text-gray-500">{attachment.fileKey}</p>
                    </div>
                    <a
