        ...
        <CustomModal title="트레이너 수정" onClose={() => setShowEditModal(false)}>
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 bg-gray-50 border border-gray-200 rounded-lg p-3">
                트레이너 정보 수정 시 권한은 편집이 불가능합니다. 새로운 계정을 생성하셔서 권한을 지정하실 수 있습니다.
              </p>
            </div>
