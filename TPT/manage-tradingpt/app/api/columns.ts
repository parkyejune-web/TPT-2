...
// 베스트 칼럼 지정
export async function setBestColumn(
  columnId: number
): Promise<ApiResponse<number>> {
...
// 베스트 칼럼 해제
export async function unsetBestColumn(
  columnId: number
): Promise<ApiResponse<number>> {
  return apiCall<number>(`/api/v1/admin/columns/${columnId}/best/cancel`, {
    method: 'PATCH',
  });
}
...
export async function deleteComment(
  ...
  return apiCall<number>(`/api/v1/admin/columns/${columnId}/comments/${commentId}`, {
    method: 'DELETE',
  });
}
