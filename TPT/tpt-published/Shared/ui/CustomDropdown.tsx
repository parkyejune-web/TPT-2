  ...
  return (
    <div className="relative inline-block">
      ...
      <button
        ...
        className="flex items-center justify-between px-2 py-1.5 border border-gray-300 rounded-md bg-white text-gray-700 text-xs
          ...
          <ul className="divide-y divide-gray-100">
            {options.map((option, index) => (
              <li
                ...
                className="px-4 py-2 text-xs text-gray-700 cursor-pointer hover:bg-gray-200"
              >
                {option}
              </li>
            ))}
