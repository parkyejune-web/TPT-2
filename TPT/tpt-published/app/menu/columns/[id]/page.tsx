...
interface Comment {
  commentId: number;
  writerName: string;
  nickName?: string | null; // 닉네임이 있으면 우선 사용
  content: string;
  createdAt: string;
}
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 pb-20 flex flex-col md:flex-row gap-10 mt-20">
      ...
      <div className="w-full md:w-3/4 flex flex-col">
        ...
        {/* 본문 */}
        <div
          className="max-w-none mb-6 column-content"
        ...
        <style jsx>{`
          ...
          .column-content :global(a:hover) {
            color: #4338ca;
          }
          .column-content :global(strong),
          .column-content :global(b) {
            font-weight: 700;
          }
          .column-content :global(em),
          .column-content :global(i) {
            font-style: italic;
          }
          .column-content :global(u) {
            text-decoration: underline;
          }
          .column-content :global(s),
          .column-content :global(strike) {
            text-decoration: line-through;
          }
          .column-content :global(blockquote) {
          ...
          .column-content :global(pre code) {
            background-color: transparent;
            padding: 0;
            color: inherit;
          }
          .column-content :global(img) {
            max-width: 100%;
            height: auto;
            margin: 1rem 0;
            border-radius: 0.5rem;
          }
          .column-content :global(table) {
            width: 100%;
            border-collapse: collapse;
            margin: 1rem 0;
          }
          .column-content :global(th),
          .column-content :global(td) {
            ...
            column.comments.map((comment) => (
              <div key={comment.commentId} className="border-b border-gray-200 pb-3">
                <p className="text-sm font-medium text-gray-800">
                  {comment.nickName || comment.writerName}
                </p>
