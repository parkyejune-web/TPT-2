          ...
          {monthList.map((month) => (
            ...
            >
              <div className="flex items-center gap-3">
                <List size={16} style={{ color: '#0F3570' }} />
                <div className="flex items-center gap-1">
                  <span className="text-md font-semibold" style={{ color: '#0F3570' }}>{month}</span>
                  <span className="text-sm" style={{ color: '#0F3570' }}>월간 매매일지</span>
                </div>
              </div>
              <Image
                src="/images/my_month_button_img.svg"
                alt="이동"
                width={200}
                height={60}
              />
