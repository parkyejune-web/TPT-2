...
type InvestmentType = '스윙' | '데이'; // | '스켈핑' - 스켈핑 투자 유형 삭제됨
...
const options: InvestmentType[] = ['스윙', '데이']; // '스켈핑' - 스켈핑 투자 유형 삭제됨
            ...
            <button
              ...
              className={[
                ...
                selected
                  ...
                  // : 'bg-blue-500 text-white border-blue-500' - 스켈핑 삭제됨
                  : opt === '스윙'
                    ? 'border-amber-400 text-gray-800'
                    : 'border-emerald-500 text-gray-800',
                    // : 'border-blue-400 text-gray-800' - 스켈핑 삭제됨
